...
const ProductPage = (props) => {
  ...
  useEffect(() => {
    const productDetails = localStorage.getItem("productPage");
    ctx.addproductObj(JSON.parse(productDetails));
  },[]);
  // let Image1 = null
  // let Image2 = null
  // let Image3 = null
      ...
      <Card className="mt-5 border-0">
        <Row className="row justify-content-center">
          ...
          <Col lg={4} sm={8}>
            ...
            <Button type="click" onClick={() => addToCard(ctx.productDetails)}>
              Add to Card
            </Button>
          </Col>
        </Row>
